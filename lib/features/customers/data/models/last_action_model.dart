...
class LastActionModel extends LastAction {
  const LastActionModel({required int? dateTime,
    required int? postponeDateTime,
    required EventModel? event, required EmployeeModel? lastActionBy, required String? actionDescription}) : super(dateTime: dateTime, postponeDateTime: postponeDateTime, event: event, lastActionBy: lastActionBy, actionDescription: actionDescription);
  factory LastActionModel.fromJson(Map<String, dynamic> json) =>
      LastActionModel(
        ...
        lastActionBy: json["lastActionBy"] != null ? EmployeeModel.fromJson(json["lastActionBy"]) : null,
