...
import '../../../teams/domain/use_cases/team_member_use_cases.dart';
import '../../../teams/presentation/widgets/employees_grid_view.dart';
import '../../../teams/presentation/widgets/employess_picker_app_bar.dart';
import '../../../teams/presentation/widgets/selected_employee_list_view.dart';
...
class _EmployeePickerScreenState extends State<EmployeePickerScreen> {
  ...
  void initState() {
    ...
    _getPageEmployees(refresh: true, employeePickerTypes: EmployeePickerTypes.ASSIGN_MEMBER.name);
        ...
        EmployeePickerTypes.SELECT_EMPLOYEE.name || widget.employeePickerArgs.employeePickerTypes ==
  ...
  Widget _buildList(EmployeeCubit cubit, EmployeeState state) {
    ...
    if (state is StartRefreshEmployees) {
